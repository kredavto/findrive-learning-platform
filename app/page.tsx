...
const learningBlocks: TrainingBlock[] = [
  {
    ...
    lessons: [
      lesson("company-model", "Приветствие", "12 мин", "Добро пожаловать в Академию «ФИНДРАЙВ»! В первом уроке ты познакомишься с компанией, её бизнес-моделью и правилами работы амбассадора. ООО МКК «ФИНДРАЙВ» — это микрокредитная компания, работающая на рынке займов под залог автомобилей.", "Начинай знакомство с понятного ответа: что представляет из себя компания ООО МКК «ФИНДРАЙВ», каким видом деятельности она занимается и где можно проверить её официальный статус.", ["Проверяй карточку компании в реестре Банка России.", "Разделяй продукт для заёмщика и привлечение средств в бизнес.", "Не превращай данные презентации в обещание результата."], "Доверие начинается с проверяемых фактов, а не с убедительных формулировок.", question("company-model-q", "С чего безопаснее начать рассказ о компании?", [["rate", "С заявленной доходности"], ["facts", "Со статуса, модели работы и проверяемых источников"]], "facts", "Верно: сначала идентификация компании и подтверждённые факты.")),
      lesson("borrower-product", "Продукт для заёмщика", "14 мин", "Основной продукт — заём под залог автомобиля. Решение принимается после идентификации клиента, проверки документов и оценки автомобиля.", "Залог снижает риск, но не исключает просрочку, расходы на взыскание и изменение стоимости автомобиля.", ["Автомобиль может оставаться у заёмщика.", "Условия зависят от проверки и договора.", "Амбассадор не принимает кредитное решение."], "Говори о процедуре, не обещая одобрение и конкретные условия до проверки.", question("borrower-product-q", "Что вправе обещать амбассадор заёмщику?", [["approval", "Гарантированное одобрение"], ["process", "Передачу заявки и объяснение процедуры"]], "process", "Верно: решение и условия определяет уполномоченный специалист.")),
      lesson("business-funding", "Привлечение средств", "16 мин", "Юридические лица могут быть целевой аудиторией для привлечения средств в бизнес МКК. Для ИП требуется отдельная проверка статуса участника или учредителя компании.", "Если у инвестора нет своего юридического лица, сориентируй его на заключение договора с учредителем МКК как с физлицом, поскольку непосредственно сама МКК по закону может привлекать деньги только от юридических лиц.", ["Целевая аудитория — юридические лица. Инвестор может не иметь своего юридического лица, в этом случае мы не прекращаем с ним работать, но амбассадор должен предложить ему заключить договор непосредственно с учредителем МКК как с физическим лицом, чтобы не было нарушения законодательства, которое ограничивает круг инвесторов для микрофинансовых компаний только юридическими лицами.", "ИП проверяется как физическое лицо со специальным статусом.", "Условия определяются договором и согласуются специалистом."], "Амбассадор квалифицирует интерес и передаёт контакт, но не заключает договор от имени компании.", question("business-funding-q", "Кого можно сразу отнести к целевой аудитории?", [["individual", "Любое физическое лицо"], ["legal", "Юридическое лицо"]], "legal", "Верно: юридическое лицо — допустимый целевой клиент.")),
  ...
  },
  {
    ...
    lessons: [
      lesson("role-boundaries", "Задачи и границы роли", "12 мин", "Амбассадор знакомит с компанией, выявляет интерес и организует контакт с уполномоченным менеджером.", "Представляйся амбассадором и не создавай впечатление, что ты принимаешь решения от имени МКК.", ["Раскрывай свою роль в первом сообщении.", "Не подписывай и не толкуй договоры.", "Делегируй юридические и финансовые вопросы."], "Чёткая граница роли защищает клиента, компанию и самого амбассадора.", question("role-boundaries-q", "Может ли амбассадор согласовать ставку?", [["yes", "Да, если клиент готов"], ["no", "Нет, вопрос передаётся специалисту"]], "no", "Верно: условия не согласуются амбассадором.")),
      lesson("target-audience", "Целевая аудитория", "10 мин", "Основная аудитория — руководители и представители юридических лиц, заинтересованные в финансировании бизнеса компании.", "До презентации определи тип клиента и полномочия собеседника.", ["Юридическое лицо — допустимая аудитория.", "ИП — только после проверки статуса участника МКК.", "Обычные физлица не являются целью кампании."], "Квалификация аудитории предшествует любому обсуждению условий.", question("target-audience-q", "Когда можно продолжить разговор с ИП?", [["always", "Всегда"], ["verified", "После подтверждения статуса участника или учредителя"]], "verified", "Верно: статус ИП нужно подтвердить до презентации.")),
      lesson("workflow", "Рабочий процесс", "14 мин", "Последовательность работы: согласие на разговор, квалификация, краткая презентация, фиксация вопроса, передача менеджеру и отражение статуса.", "Каждый шаг должен иметь понятный результат и следующий согласованный шаг.", ["Не отправляй материалы без согласия.", "Фиксируй источник и статус контакта.", "Не собирай лишние персональные данные."], "Хороший процесс — это управляемый маршрут, а не серия случайных сообщений.", question("workflow-q", "Что должно быть до отправки презентации?", [["consent", "Согласие на коммуникацию"], ["payment", "Предварительная оплата"]], "consent", "Верно: сначала согласие и проверка аудитории.")),
      lesson("lead-handoff", "Передача лида", "12 мин", "Лид передаётся менеджеру после подтверждения интереса и согласия клиента на контакт.", "Передавай только минимально необходимую информацию и зафиксированный вопрос клиента.", ["Укажи источник лида.", "Зафиксируй согласие и удобный канал связи.", "Не добавляй собственные обещания в комментарии."], "Качественная передача помогает менеджеру продолжить диалог без повторного допроса клиента.", question("lead-handoff-q", "Что обязательно при передаче лида?", [["consent", "Согласие клиента"], ["passport", "Копия паспорта"]], "consent", "Верно: согласие обязательно, лишние документы амбассадор не собирает.")),
    ],
    finalQuestions: [
      ...
      lesson("meeting-to-discovery", "Встреча → Выяснение", "28 мин", "СПИН-продажи заменяют презентационный монолог последовательной диагностикой. Четыре типа вопросов используются не одновременно, а по мере развития разговора: сначала контекст, затем проблема, её последствия и только после этого — ценность возможного решения.", "Не превращай СПИН в допрос. Объясняй, зачем задаёшь вопрос, внимательно слушай ответ и не переходи к следующему типу, пока предыдущий не дал достаточно информации.", ["Ситуационные вопросы помогают быстро собрать необходимый контекст.", "Проблемные вопросы помогают клиенту назвать реальные затруднения.", "Извлекающие вопросы показывают последствия нерешённой проблемы.", "Направляющие вопросы позволяют клиенту самому описать ценность решения."], "Хорошая диагностика позволяет клиенту самому сформулировать значимость задачи и согласовать следующий шаг без давления.", question("meeting-to-discovery-q", "Какой вопрос является извлекающим?", [["people", "Сколько сотрудников в компании?"], ["impact", "Как нехватка средств влияет на сроки контрактов?"]], "impact", "Верно: извлекающий вопрос раскрывает последствия уже названной проблемы."), [
        {
          ...
          note: "Переходи дальше, как только контекста достаточно. Длинная анкета утомляет клиента.",
        },
        {
          title: "Проблемные вопросы",
          when: "Используй после получения контекста, чтобы выявить неудобства, ограничения или упущенные возможности. Вопрос не должен внушать клиенту проблему, которой у него нет.",
          ...
          note: "Если клиент не видит проблемы, не спорь: уточни приоритеты или заверши тему.",
        },
        {
          title: "Извлекающие вопросы",
          when: "Задавай, когда проблема уже признана, но её влияние пока кажется незначительным. Они помогают оценить последствия для сроков, выручки, команды или отношений с партнёрами.",
          ...
          note: "Не драматизируй и не запугивай. Клиент сам оценивает значимость последствий.",
        },
        {
  ...
  },
  {
    ...
    lessons: [
      lesson("personal-link", "Персональная ссылка", "10 мин", "Персональная ссылка связывает обращение с амбассадором и помогает корректно атрибутировать результат.", "Отправляй ссылку только после согласия и только подходящей аудитории.", ["Не изменяй код ссылки.", "Не публикуй её в массовых рассылках.", "Фиксируй канал и дату отправки."], "Точная атрибуция начинается с корректного использования ссылки.", question("personal-link-q", "Когда отправляется персональная ссылка?", [["mass", "В массовой рассылке"], ["consent", "После согласия целевого клиента"]], "consent", "Верно: ссылка отправляется адресно и с согласия.")),
      lesson("crm-statuses", "CRM и статусы", "14 мин", "Статусы отражают движение лида без раскрытия лишних данных: новый, квалифицирован, передан, на проверке, завершён или дубль.", "Статус — это факт процесса, а не оценка клиента.", ["Обновляй статус после события.", "Не храни чувствительные документы.", "Дубли не учитываются повторно."], "Чистые статусы дают честную аналитику и справедливую атрибуцию.", question("crm-statuses-q", "Что фиксирует статус лида?", [["process", "Факт этапа процесса"], ["opinion", "Личное мнение амбассадора"]], "process", "Верно: статус отражает событие процесса.")),
      lesson("reward", "Вознаграждение", "15 мин", "Предварительный расчёт помогает ориентироваться, но обязательство к выплате возникает только после подтверждения условий программы.", "Не обещай себе или клиенту выплату до проверки атрибуции и результата.", ["Проверяется источник лида.", "Исключаются дубли.", "Подтверждается целевое действие.", "Фиксируется итоговая сумма и дата."], "Прозрачный расчёт строится на событиях, а не на ожиданиях.", question("reward-q", "Когда сумма становится подтверждённой?", [["lead", "После создания лида"], ["verified", "После проверки условий программы"]], "verified", "Верно: предварительная сумма не равна подтверждённой.")),
      lesson("reporting", "Отчётность", "10 мин", "Амбассадор видит только необходимые ему данные: источник, статус, ответственного и состояние расчёта.", "Доступ к данным ограничивается ролью и задачей пользователя.", ["Не выгружай клиентские данные без необходимости.", "Используй системные отчёты.", "Сообщай об ошибках атрибуции через поддержку."], "Минимизация данных снижает риск и упрощает работу.", question("reporting-q", "Какие данные нужны амбассадору?", [["all", "Все документы клиента"], ["minimum", "Только необходимые статусы и расчёты"]], "minimum", "Верно: доступ ограничивается необходимым минимумом.")),
    ],
    finalQuestions: [
  ...
  },
  {
    ...
    lessons: [
      lesson("green-yellow-red", "Можно / нельзя", "15 мин", "Матрица коммуникации делит формулировки на зелёную, жёлтую и красную зоны.", "Красная зона означает остановку диалога и передачу вопроса специалисту.", ["Зелёная: подтверждённые факты и описание роли.", "Жёлтая: цифры и условия только по утверждённому материалу.", "Красная: гарантии, давление и скрытие рисков."], "Перед отправкой сообщения определи его зону.", question("zones-q", "К какой зоне относится гарантия дохода?", [["green", "Зелёная"], ["red", "Красная"]], "red", "Верно: обещание дохода недопустимо.")),
      lesson("ads-consent", "Реклама и согласия", "12 мин", "Рекламная коммуникация начинается после согласия адресата и прекращается после отказа.", "Отказ не нужно преодолевать — его нужно уважать и фиксировать.", ["Не используй массовый спам.", "Храни подтверждение согласия.", "После отказа не продолжай рекламный контакт."], "Добровольность контакта — обязательное условие коммуникации.", question("ads-consent-q", "Что делать после отказа?", [["retry", "Продолжить убеждать"], ["stop", "Прекратить рекламную коммуникацию"]], "stop", "Верно: отказ завершает рекламный диалог.")),
...
const jobDemoLessons: TrainingLesson[] = [
  lesson("demo-welcome", "Привет!", "5 мин", "Добро пожаловать в ФИНДРАЙВ. Пройди небольшую демонстрацию должности, которая поможет тебе увидеть работу амбассадора от первого знакомства с компанией до выплаты вознаграждения.", "Изучи демонстрацию должности, краткую информацию о компании и роли амбассадора, затем пройди небольшое обучение особенностям привлечения инвестиций в микрокредитную компанию. Пройденный материал позволит тебе максимально эффективно вести переговоры с потенциальными инвесторами.", ["Пройди 14 коротких тем последовательно.", "В каждом разделе сначала доступно видео, затем открытая текстовая часть и мини-тест.", "Следующий раздел открывается после правильного ответа."], "После демонстрации должности платформа автоматически откроет основной курс амбассадора.", question("demo-welcome-q", "Что является целью демонстрации должности?", [["route", "Понять роль, результат и полный рабочий маршрут амбассадора"], ["memorize", "Выучить только размер возможного вознаграждения"]], "route", "Верно: сначала нужно увидеть должность как целостную систему действий и результатов.")),
  lesson("demo-company-history", "Кто мы — история компании", "7 мин", "ФИНДРАЙВ — микрокредитная компания, специализирующаяся на займах под залог автомобилей. Компания соединяет технологичный процесс оценки, обеспеченный продукт и персональную работу с клиентом.", "Историю компании рассказываем потенциальным инвесторам через проверяемые факты: статус, специализацию, продукт и этапы развития.", ["Компания работает в сегменте займов под залог автомобилей.", "Статус организации проверяется в официальном реестре Банка России.", "Данные презентации описывают состояние бизнеса на указанную в ней дату и не заменяют актуальную отчётность."], "Амбассадор создаёт доверие точностью фактов, а не громкими обещаниями.", question("demo-company-history-q", "Как правильно рассказывать историю ФИНДРАЙВ?", [["facts", "Через подтверждаемые факты о статусе, специализации и продукте"], ["claims", "Через неподтверждённые обещания быстрого роста"]], "facts", "Верно: проверяемая история повышает доверие и снижает риск неверной коммуникации.")),
  lesson("demo-mission", "Миссия и цель компании", "6 мин", "Миссия ФИНДРАЙВ — помогать клиентам решать задачу получения быстрого финансирования под залог автомобиля, развивая устойчивый и ответственный бизнес. Цель компании — максимально масштабировать качественный портфель займов без потери контроля над рисками и клиентским сервисом.", "Рост важен только вместе с качеством портфеля, прозрачностью условий и ответственным отношением к клиенту.", ["Клиент должен понимать продукт, процедуру и существенные условия.", "Компания стремится к устойчивому росту, а не к сделке любой ценой.", "Амбассадор поддерживает миссию честной квалификацией и точной передачей лида."], "Миссия превращается в практику через каждое корректное обещание, вопрос и следующий шаг.", question("demo-mission-q", "Какое действие амбассадора соответствует миссии компании?", [["qualify", "Честно квалифицировать потребность и передать клиента специалисту"], ["pressure", "Давить на клиента ради быстрого согласия"]], "qualify", "Верно: ответственная квалификация поддерживает и клиента, и устойчивость бизнеса.")),
  lesson("demo-financials", "Финансовые показатели", "8 мин", "По данным финансовой отчётности компании на 01.07.2026 портфель займов составляет 27,5 млн ₽ и вырос на 66% за 18 месяцев. В портфеле компании 87 активных договоров, 79 уникальных клиентов, активы компании 31,6 млн ₽, чистая прибыль 1,48 млн ₽.", "Любая финансовая цифра привязана к дате и источнику. Перед внешним использованием её актуальность нужно подтвердить.", ["27,5 млн ₽ — размер портфеля на дату презентации.", "87 договоров и 79 уникальных клиентов описывают структуру портфеля.", "31,6 млн ₽ активов и 1,48 млн ₽ прибыли требуют подтверждения актуальной отчётностью."], "Финансовые показатели помогают объяснить масштаб, но не являются гарантией будущего результата.", question("demo-financials-q", "Как корректно использовать показатели презентации?", [["dated", "Назвать дату и источник, а актуальность подтвердить перед встречей"], ["guarantee", "Представить прошлые показатели как гарантию будущего результата"]], "dated", "Верно: показатель без даты и контекста легко превращается в вводящее в заблуждение обещание.")),
  lesson("demo-development", "Планы развития", "7 мин", "Планы развития строятся вокруг роста качественного портфеля, расширения партнёрских каналов, улучшения клиентского пути и усиления контроля рисков. Амбассадор помогает компании расти за счёт целевых контактов и дисциплины работы с лидами.", "Амбассадор должен иметь четкое представление о планах развития компании, чтобы его усилия, направленные на достижение общего успеха, были реально измеримыми", ["Расширять сеть качественных партнёрств и рекомендаций.", "Повышать конверсию за счёт правильной квалификации, а не давления.", "Сохранять качество оценки, документов и клиентского сервиса при росте."], "Роль амбассадора в развитии — создавать воспроизводимый поток целевых и корректно переданных контактов.", question("demo-development-q", "Что помогает устойчивому развитию компании?", [["quality", "Рост целевых каналов вместе с контролем качества и рисков"], ["volume", "Любой объём контактов без квалификации"]], "quality", "Верно: устойчивый рост требует одновременно объёма и качества.")),
  lesson("demo-audience", "Целевые и нецелевые клиенты", "9 мин", "Для привлечения средств в бизнес целевыми клиентами являются юридические лица. Индивидуальный предприниматель рассматривается только после проверки допустимого статуса участника или учредителя МКК. Обычные физические лица не относятся к целевой аудитории инвесторов МКК, поэтому договора с ними заключают только учредители МКК как физические лица. Поэтому при переговорах с частными инвесторами нужно спрашивать, есть ли у них юридическое лицо? Если нет, то готовы ли они заключить договор займа непосредственно с учредителем МКК, а не с самой компанией?", "Сначала определи тип клиента и полномочия собеседника — только затем обсуждай продукт и организуй контакт со специалистом.", ["Целевой контакт представляет юридическое лицо и влияет на финансовое решение.", "Для ИП требуется отдельная проверка статуса до обсуждения условий.", "Нецелевой контакт не соответствует аудитории, не имеет полномочий или ожидает банковский вклад без риска."], "Качественная квалификация защищает время клиента, амбассадора и команды ФИНДРАЙВ.", question("demo-audience-q", "Кого можно сразу отнести к целевой аудитории привлечения средств?", [["legal", "Уполномоченного представителя юридического лица"], ["individual", "Любое физическое лицо с накоплениями"]], "legal", "Верно: юридические лица являются основной целевой аудиторией этого направления.")),
  lesson("demo-products", "Продукты", "8 мин", "У ФИНДРАЙВ два разных контура коммуникации. Для заёмщика — заём под залог автомобиля после проверки клиента, документов и обеспечения. Для развития бизнеса — договорное привлечение средств от допустимых категорий клиентов.", "Не смешивай заём для клиента и финансирование бизнеса: у них разные аудитории, документы, условия и риски.", ["По продукту для заёмщика решение принимает уполномоченный специалист.", "По финансированию бизнеса условия определяются актуальным договором.", "Амбассадор знакомит, квалифицирует и передаёт контакт, но не принимает договорное решение."], "Понятное разделение продуктов помогает задавать правильные вопросы и не давать лишних обещаний.", question("demo-products-q", "Что важно сделать до презентации продукта?", [["separate", "Определить, нужен клиенту заём или он обсуждает финансирование бизнеса"], ["same", "Использовать одинаковый сценарий для любого запроса"]], "separate", "Верно: два продукта требуют разных маршрутов коммуникации.")),
  lesson("demo-average-ticket", "Средний чек и условия займов", "9 мин", "По статистическим данным компании, отражённым в презентации по состоянию на 01.07.2026 г., соотношение размера портфеля займов 27,5 млн ₽ к 87 договорам позволяет рассчитать средний чек займа в размере 316 тыс. ₽ на 1 договор. Важно понимать, что это расчётный показатель, а не обещанный размер нового займа. В презентации для инвесторов указана минимальная сумма привлечения в размере 1 млн ₽, максимальная сумма не ограничена, фиксированная доходность 24% годовых и срок 36 месяцев отражены в Договоре займа — применимость этих данных всегда проверяется по актуальному шаблону договора, который предоставляется амбассадору сразу после успешного завершения обучения.", "Средний чек описывает прошлую совокупность сделок; персональные условия появляются только после проверки и согласования.", ["Не называй расчётный средний чек индивидуальным лимитом клиента.", "Не обещай ставку, срок или одобрение до проверки актуальных условий.", "Перед встречей сверяй цифры с действующей презентацией и шаблоном договора."], "Цифра полезна, когда амбассадор объясняет её смысл, дату и ограничения.", question("demo-average-ticket-q", "Что означает ориентир около 316 тыс. ₽?", [["portfolio", "Средний чек займа на одного Заемщика, рассчитанный статистическим путем, с использованием данных предыдущих периодов."], ["limit", "Гарантированный лимит каждого нового займа"]], "portfolio", "Верно: это аналитический ориентир, а не персональное предложение.")),
  lesson("demo-ambassador-role", "Амбассадор и его роль", "8 мин", "Кто же такой амбассадор и в чём заключается его основная функция? Для нас амбассадор — это партнёр, друг, который имеет большой опыт общения с состоятельными клиентами и лично знаком со многими потенциальными инвесторами, готовыми вложить свои средства в бизнес компании. А с теми, с кем он пока лично не знаком, он всегда чётко знает, как можно познакомиться, выйти с ними на контакт и как правильно презентовать продукт и бизнес компании потенциальному инвестору.", "Амбассадор представляет возможность диалога, но не заменяет кредитного, финансового или юридического специалиста.", ["Раскрывай свою роль в начале общения.", "Фиксируй интерес, контекст и согласованный следующий шаг.", "Передавай вопросы об условиях, договорах и гарантиях ответственному специалисту."], "Сильный амбассадор не продаёт обещание — он профессионально создаёт качественную встречу.", question("demo-ambassador-role-q", "Каков главный результат работы амбассадора?", [["handoff", "Квалифицированный контакт с понятным следующим шагом"], ["contract", "Самостоятельно подписанный от имени компании договор"]], "handoff", "Верно: амбассадор отвечает за качественный вход в процесс и корректную передачу контакта.")),
  ...
  lesson("demo-sales-plans", "Планы продаж", "7 мин", "План продаж амбассадора раскладывается на управляемые действия: новые целевые контакты, квалифицированные диалоги, назначенные встречи, переданные лиды и подтверждённые результаты. Конкретные значения согласуются с руководителем.", "Управляй не только финальным результатом, но и конверсией между этапами воронки.", ["Планируй количество новых целевых контактов на неделю.", "Отслеживай переходы: контакт → диалог → встреча → квалифицированный лид.", "Разбирай причины потерь и назначай следующий шаг с датой."], "Регулярный небольшой объём качественных действий предсказуемее резких рывков.", question("demo-sales-plans-q", "Из чего должен состоять рабочий план продаж?", [["funnel", "Из целевых действий и конверсий по этапам воронки"], ["wish", "Только из желаемой суммы вознаграждения"]], "funnel", "Верно: план должен опираться на действия, которыми амбассадор может управлять.")),
  lesson("demo-reports", "Отчёты амбассадора", "7 мин", "Отчёт показывает движение каждого лида и помогает команде вовремя подключиться. Минимальная запись содержит источник, тип клиента, текущий этап, результат контакта, следующий шаг, дату и препятствие.", "Хороший отчёт позволяет продолжить работу без дополнительного восстановления контекста.", ["Фиксируй только необходимые рабочие данные и согласие на коммуникацию.", "Обновляй этап после каждого значимого контакта.", "В еженедельном отчёте сравнивай план, факт, конверсию и причины отклонений."], "Отчётность — не бюрократия, а инструмент атрибуции, управления воронкой и своевременной помощи.", question("demo-reports-q", "Что обязательно указать по активному лиду?", [["next", "Текущий этап, результат контакта и следующий шаг с датой"], ["memory", "Ничего — достаточно помнить договорённость"]], "next", "Верно: прозрачный следующий шаг делает работу управляемой.")),
  lesson("demo-rewards", "Выплата вознаграждений", "8 мин", "После подтверждения целевого события компания проверяет закрепление лида, отсутствие дубля, комплект документов, базу расчёта и налоговый статус получателя. Затем сумма утверждается и выплачивается в срок, установленный агентским договором.", "Срок и сумма выплаты определяются договором и подтверждёнными данными, а не устной оценкой.", ["Проверь, что лид зарегистрирован под твоим идентификатором.", "Сверь статус целевого события и основание расчёта.", "При расхождении задай вопрос ответственному сотруднику, приложив ID лида и факты."], "Ты завершил демонстрацию должности и готов перейти к основному курсу амбассадора.", question("demo-rewards-q", "Что происходит перед выплатой вознаграждения?", [["check", "Проверка атрибуции, события, документов и базы расчёта"], ["automatic", "Автоматическая выплата за любой переданный контакт"], ["oral", "Расчёт вознаграждения по устной договорённости без сверки лида и документов"], ["meeting", "Выплата фиксированной суммы сразу после первой встречи с инвестором"]], "check", "Верно: подтверждение оснований обеспечивает прозрачность расчёта и выплаты.")),
  lesson("demo-forward", "Вперед!", "4 мин", "Ты молодец — демонстрация должности пройдена до конца. До начала переговоров с потенциальными клиентами осталось совсем чуть-чуть: необходимо пройти короткое обучение по привлечению инвестиций в микрокредитную компанию.", "Следующий этап поможет уверенно объяснять продукт, задавать правильные вопросы и договариваться о следующем шаге.", ["Закрепи особенности привлечения инвестиций в микрокредитную компанию.", "Освой структуру переговоров и работу с возражениями.", "После обучения переходи к переговорам с потенциальными клиентами."], "Ты уже разобрался в роли амбассадора. Остался короткий учебный этап — и можно переходить к практическим переговорам.", question("demo-forward-q", "Что необходимо сделать перед началом переговоров с потенциальными клиентами?", [["training", "Пройти короткое обучение по привлечению инвестиций"], ["start", "Сразу начинать переговоры без подготовки"], ["skip", "Ограничиться демонстрацией должности и пропустить учебный курс"], ["wait", "Дождаться готового договора с клиентом, не изучая продукт и технику переговоров"]], "training", "Верно: короткое обучение поможет применять материал уверенно и последовательно.")),
];
...
const demoAdditionalParagraphs: Record<string, string[]> = {
  ...
  "demo-mission": ["Мы строим масштабируемый бизнес и стремимся выйти на миллиардные обороты в ближайшие годы, поэтому для нас важно иметь партнеров-профессионалов в привлечении инвестиций, вместе с которыми мы будем достигать успехов в бизнесе и развитии."],
  "demo-development": ["Компания планирует ежегодно удваивать масштабы своего бизнеса (размер портфеля займов, выручку и активы), чтобы как можно скорее выйти на рынки микрозаймов в Москве и в других городах-миллионниках. Роль амбассадоров, которые активно помогают привлечь инвестиции в бизнес компании, является определяющей для успешного достижения поставленных целей. Поэтому мы всячески помогаем нашим партнёрам заключать успешные сделки с инвесторами, включаясь в процесс переговоров уже на ранних стадиях взаимодействия."],
  "demo-ambassador-role": ["Амбассадор формирует первичный интерес, выявляет потребность, проверяет соответствие целевой аудитории и организует следующий контакт с уполномоченным сотрудником ФИНДРАЙВ."],
...
const courseAdditionalParagraphs: Record<string, string[]> = {
  "company-model": [
    "Наши клиенты — это физические лица, индивидуальные предприниматели и юридические лица, которым срочно нужны деньги на неотложные нужды, погашение долгов в других кредитных организациях, на пополнение оборотных средств для ведения бизнеса и на покрытие кассовых разрывов.",
    "Наш целевой сегмент клиентов — это граждане и юридические лица, которые по каким-либо причинам не могут получить кредит в банке (например, у них уже итак много действующих кредитов, либо в процессе обслуживания долга была допущена длительная просрочка, которая негативно повлияла на их кредитную историю, либо просто нет возможности документально подтвердить официальный доход). Фактически такие клиенты готовы кредитоваться по ломбардной схеме, оставляя в залог свой автомобиль.",
  ],
  "business-funding": [
    "Если инвестором выступает частное лицо, с ним может заключить Договор займа только учредитель МКК как физическое лицо, поскольку другие варианты не предусматривает действующее законодательство РФ. Прежде чем заключить сделку с частным инвестором, нужно уточнить у него, готов ли он подписать договор непосредственно с учредителем МКК? Если инвестор дал положительный ответ, только после этого амбассадор может направить в МКК информацию о готовящейся сделке.",
  ],
};
...
function RegistrationGate({ state, defaultEmail, onVerificationPending }: { state: ProfileState; defaultEmail: string; onVerificationPending: (email: string) => void }) {
  ...
  return <main className="onboarding-screen">
    <section className="onboarding-card">
      ...
      <p className="onboarding-lead">Заполни карточку пользователя. После регистрации сразу откроется первый раздел демонстрации должности — «Приветствие».</p>
...
function Dashboard({ firstName, progressPercent, onNavigate, onLesson, copied, onCopy }: { firstName: string; progressPercent: number; onNavigate: (v: View) => void; onLesson: () => void; copied: string; onCopy: (text: string, key: string) => void }) {
  ...
  return <>
    <section className="page-heading">
      <div><Badge tone="date">Вторник, 4 августа</Badge><h1>Добрый день, {firstName}</h1><p>Продолжи обучение и проверь обязательное обновление комплаенса.</p></div>
    ...
    <section className="dashboard-grid">
      <article className="card course-progress-card">
        ...
        <div className="course-progress-body"><ProgressRing value={progressPercent} /><div><p className="eyebrow">Последовательная программа</p><h2>Обучение амбассадора</h2><p>Продолжи с последнего открытого урока. Прогресс сохраняется автоматически после правильного ответа.</p><div className="lesson-meta"><span><Clock3 size={16} /> 26 уроков</span><span><ClipboardCheck size={16} /> 5 итоговых тестов</span></div></div></div>
      ...
      <article className="card admission-card">
        ...
        <h2>Маршрут разрешён</h2><p>Работай с юридическими лицами. Перед контактом с ИП подтверди его статус участника компании.</p>
    ...
    <section className="learning-workspace card position-workspace">
      ...
      <div className="lesson-stage">
        ...
        <section className="video-learning-card" aria-label={`Видео к теме ${currentLesson.title}`}>
          {videoUrls[currentLesson.id] ? <><video key={videoUrls[currentLesson.id]} controls preload="metadata"><source src={videoUrls[currentLesson.id]} type="video/mp4"/>Твой браузер не поддерживает видео MP4.</video><div className="video-meta"><div><strong>{videoNames[currentLesson.id]}</strong><small>Текст темы полностью открыт ниже — просмотр видео не блокирует чтение.</small></div><label className="video-replace">Заменить MP4<input type="file" accept="video/mp4,.mp4" onChange={uploadVideo}/></label></div></> : <label className="video-upload-zone"><span><Sparkles size={28}/></span><strong>Загрузи видео к теме</strong><small>Одно видео в формате MP4. Текстовая часть уже доступна ниже и не зависит от просмотра.</small><em>Выбрать MP4</em><input type="file" accept="video/mp4,.mp4" onChange={uploadVideo}/></label>}
        ...
        {currentLesson ? <>
          ...
          <section className="video-learning-card" aria-label={`Видео к уроку ${currentLesson.title}`}>
            {videoUrls[currentLesson.id] ? <>
              <video key={videoUrls[currentLesson.id]} controls preload="metadata">
                ...
                Твой браузер не поддерживает видео MP4.
              </video>
              ...
              <span><BookOpen size={28}/></span><strong>Загрузи видео к уроку</strong><small>Одно видео в формате MP4. Текстовая часть урока доступна независимо от загрузки и просмотра видео.</small><em>Выбрать MP4</em><input type="file" accept="video/mp4,.mp4" onChange={uploadVideo}/>
            </label>}
            {videoError && <p className="video-error" role="alert">{videoError}</p>}
          </section>
          ...
          <div className="lesson-reading">
            ...
            <section className="lesson-question-card">
              ...
              {lessonAnswer && <p className={lessonAnswerCorrect ? "answer-good" : "answer-bad"}>{lessonAnswerCorrect ? currentLesson.question.explanation : "Пока неверно. Вернись к ключевым пунктам и попробуй ещё раз."}</p>}
            </section>
          ...
          <h2>{block.title}</h2><p>Ответь правильно на все вопросы. Только после этого откроется следующий блок.</p>
...
function VideoCard({ onSubmitted }: { onSubmitted: (submittedAt: string) => void }) {
  ...
  const chooseVideo = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!selected) return;
    if (!selected.type.startsWith("video/")) { setError("Выбери видеофайл."); return; }
    ...
    probe.onloadedmetadata = () => {
      ...
      if (seconds < 60 || seconds > 130) {
        setError("Запиши видео длительностью от 1 до 2 минут 10 секунд.");
        setFile(null);
    ...
    probe.onerror = () => { setError("Не удалось прочитать видео. Попробуй другой файл."); URL.revokeObjectURL(url); };
    probe.src = url;
  };
  ...
  return <>
    <section className="page-heading"><div><Badge tone="date">Финальный шаг</Badge><h1>Видеовизитка</h1><p>Запиши короткое видео на телефон и представься будущей команде.</p></div><Badge tone="active">1–2 минуты</Badge></section>
    <section className="video-card-layout"><article className="card video-brief"><h2>О чём рассказать</h2><ol><li><span>1</span><div><strong>О себе</strong><p>Кто ты, в каком городе работаешь и чем занимаешься сейчас.</p></div></li><li><span>2</span><div><strong>Сильные стороны</strong><p>Какие качества помогают тебе выстраивать доверие и доводить диалог до результата.</p></div></li><li><span>3</span><div><strong>Опыт</strong><p>Расскажи об опыте продаж, партнёрств или привлечения инвестиций.</p></div></li></ol><aside className="green-callout"><CheckCircle2 size={20}/><p>Говори естественно. Нам важны ясность, мотивация и умение кратко представить свой опыт.</p></aside></article>
      <article className="card video-recorder"><div className="card-kicker"><span><Sparkles size={17}/> Запись с телефона</span><Badge tone="neutral">до 100 МБ</Badge></div>{preview ? <><video src={preview} controls playsInline/><div className="video-file-summary"><div><strong>{file?.name}</strong><small>{Math.floor(duration / 60)}:{String(duration % 60).padStart(2, "0")} · {(Number(file?.size || 0) / 1024 / 1024).toFixed(1)} МБ</small></div><label className="secondary-button">Перезаписать<input type="file" accept="video/*" capture="user" onChange={chooseVideo}/></label></div></> : <label className="camera-upload"><span><Sparkles size={28}/></span><strong>Записать видеовизитку</strong><p>На телефоне откроется камера. Держи устройство вертикально, выбери тихое и хорошо освещённое место.</p><em>Открыть камеру</em><input type="file" accept="video/*" capture="user" onChange={chooseVideo}/></label>}{error && <p className="video-error" role="alert">{error}</p>}<button className="primary-button video-submit" disabled={!file || uploading} onClick={submit}>{uploading ? "Загружаем видео…" : "Отправить видеовизитку"}<ArrowRight size={17}/></button></article>
    </section>
  </>;
}
...
const knowledgeMaterials = [
  {
    title: "Презентация ФИНДРАЙВ — desktop",
    description: "Горизонтальная презентация компании для демонстрации на компьютере, большом экране и во время личных встреч.",
    href: "/materials/findrive-presentation-desktop.pdf",
    format: "PDF",
    meta: "Версия для экрана",
  },
  {
    title: "Презентация ФИНДРАЙВ — mobile",
    description: "Вертикальная презентация компании, адаптированная для удобного просмотра потенциальным инвестором на телефоне.",
    href: "/materials/findrive-presentation-mobile.pdf",
    format: "PDF",
    meta: "Версия для телефона",
  },
  {
    title: "Агентский договор ФИНДРАЙВ — амбассадор",
    description: "Шаблон агентского договора для оформления сотрудничества компании с амбассадором.",
    href: "/materials/findrive-agent-agreement-template.docx",
    format: "DOCX",
    meta: "Шаблон договора",
  },
  {
    title: "Договор займа с учредителем МКК",
    description: "Шаблон договора для привлечения займа от физического лица — учредителя микрокредитной компании.",
    href: "/materials/findrive-founder-loan-agreement-template.docx",
    format: "DOCX",
    meta: "Вариант для учредителя",
  },
  {
    title: "Договор займа с ООО МКК «ФИНДРАЙВ»",
    description: "Шаблон договора займа с компанией: сумма 10 млн ₽, фиксированная ставка 24% годовых и срок 3 года.",
    href: "/materials/findrive-loan-agreement-10m-template.docx",
    format: "DOCX",
    meta: "Вариант для инвестора",
  },
];

function ThankYou({ firstName }: { firstName: string }) {
  return <section className="thank-you-page"><div className="thank-you-hero"><span><Award size={34}/></span><Badge tone="active">Курс завершён</Badge><h1>{firstName}, поздравляем!</h1><p>Ты успешно прошёл программу амбассадора ФИНДРАЙВ и отправил видеовизитку. Спасибо за внимание к материалам и готовность представлять компанию профессионально.</p></div><div className="materials-heading"><div><small>Рабочий комплект</small><h2>Полезные материалы для работы с клиентами</h2></div><p>Скачай презентации и шаблоны. Перед отправкой договоров заполни реквизиты и проверь актуальность редакции у ответственного специалиста.</p></div><div className="materials-grid">{usefulMaterials.map((material) => <a className="card material-download" key={material.href} href={material.href} download><span><FileText size={23}/></span><div><Badge tone="neutral">{material.format}</Badge><h3>{material.title}</h3><p>{material.description}</p></div><ArrowRight size={19}/></a>)}</div><aside className="green-callout"><CheckCircle2 size={20}/><p>Используй только актуальные версии материалов и не изменяй существенные условия договоров без согласования с компанией.</p></aside></section>;
}
...
function Scripts({ query, setQuery, filtered, active, setActive, copied, onCopy }: { query: string; setQuery: (v:string)=>void; filtered: typeof scripts; active:number; setActive:(v:number)=>void; copied:string; onCopy:(t:string,k:string)=>void }) {
  ...
  return <><section className="page-heading"><div><Badge tone="date">База знаний</Badge><h1>Безопасные скрипты</h1><p>Используй формулировки только из актуальной утверждённой версии.</p></div><Badge tone="active">Целевая аудитория: юрлица</Badge></section>
...
function Documents() {
  ...
  <section className="card company-documents"><div className="section-head"><div><Badge tone="active">База знаний</Badge><h2>Учредительные документы компании</h2><p>Оригиналы документов ООО МКК «ФИНДРАЙВ» для проверки реквизитов и подготовки рабочих материалов.</p></div><Badge tone="neutral">{companyDocuments.length} документ</Badge></div><div className="company-document-grid">{companyDocuments.map((document) => <a className="company-document-card" key={document.href} href={document.href} download><span><FileCheck2 size={24}/></span><div><div><Badge tone="neutral">{document.format}</Badge><small>Редакция от {document.updated}</small></div><h3>{document.title}</h3><p>{document.description}</p><strong>Скачать оригинал <ArrowRight size={16}/></strong></div></a>)}</div><aside className="document-confidentiality"><ShieldCheck size={17}/><p>Документ содержит банковские и контактные реквизиты компании. Используй его только для рабочих задач и сверяй актуальность перед отправкой клиенту.</p></aside></section>
  <section className="card company-documents knowledge-materials"><div className="section-head"><div><Badge tone="active">База знаний</Badge><h2>Презентации и договоры</h2><p>Материалы для знакомства с компанией, проведения переговоров, привлечения инвестиций и оформления сотрудничества с амбассадором.</p></div><Badge tone="neutral">{knowledgeMaterials.length} материалов</Badge></div><div className="company-document-grid">{knowledgeMaterials.map((document) => <a className="company-document-card" key={document.href} href={document.href} download><span><FileText size={24}/></span><div><div><Badge tone="neutral">{document.format}</Badge><small>{document.meta}</small></div><h3>{document.title}</h3><p>{document.description}</p><strong>Скачать файл <ArrowRight size={16}/></strong></div></a>)}</div><aside className="document-confidentiality"><ShieldCheck size={17}/><p>Перед отправкой материалов потенциальному инвестору проверь актуальность презентации и условий договора у ответственного сотрудника компании.</p></aside></section>
