...
function PositionDemo({ firstName, progress, onProgress, onComplete }: { firstName: string; progress: CourseProgress; onProgress: React.Dispatch<React.SetStateAction<CourseProgress>>; onComplete: () => void }) {
  ...
  return <>
    <section className="page-heading learning-heading demo-heading">
      <div><Badge tone="active">Обязательный вводный этап</Badge><h1>Демонстрация должности &quot;Амбассадор&quot;</h1><p>Познакомьтесь с компанией, функционалом позиции амбассадор и его ролью. После этого Вам откроется основной курс обучения по привлечению инвестиций.</p></div>
      ...
      <div className="lesson-stage">
        ...
        <div className="lesson-reading">
          {currentLesson.id === "demo-welcome" ? <>
            ...
            <p className="lesson-intro welcome-description">Демонстрация должности поможет увидеть работу амбассадора целиком до начала основного курса: от первого знакомства с компанией до выплаты вознаграждения.</p>
