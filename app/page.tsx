...
const learningBlocks: TrainingBlock[] = [
  {
    ...
    lessons: [
      ...
      lesson("business-funding", "Привлечение средств", "16 мин", "Юридические лица могут быть целевой аудиторией для привлечения средств в бизнес МКК. Для ИП требуется отдельная проверка статуса участника или учредителя компании.", "Не смешивай договор финансирования бизнеса с банковским вкладом или займом для клиента.", ["Целевая аудитория — юридические лица.", "ИП проверяется как физическое лицо со специальным статусом.", "Условия определяются договором и согласуются специалистом."], "Амбассадор квалифицирует интерес и передаёт контакт, но не заключает договор от имени компании.", question("business-funding-q", "Кого можно сразу отнести к целевой аудитории?", [["individual", "Любое физическое лицо"], ["legal", "Юридическое лицо"]], "legal", "Верно: юридическое лицо — допустимый целевой клиент.")),
