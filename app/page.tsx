      ...
      <div className="lesson-stage">
        ...
        <div className="lesson-reading">
          {currentLesson.id === "demo-welcome" ? <>
            ...
            <p className="lesson-intro welcome-description">Демонстрация должности поможет увидеть работу амбассадора целиком до начала основного курса: от знакомства с компанией до выплаты вознаграждения.</p>
